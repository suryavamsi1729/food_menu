...
const LogInPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center bg-gradient">
      <form className="w-auto h-auto flex flex-col justify-start items-center gap-4 p-6 md:p-8 rounded-2xl bg-card border border-card-border" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button className="w-full min-w-64 md:min-w-72 py-2 px-3 mb-2 bg-primary hover:bg-primary-hover active:bg-primary-active text-xs font-medium text-text rounded-xl mt-2 cursor-pointer" type="submit" disabled={loading}>
